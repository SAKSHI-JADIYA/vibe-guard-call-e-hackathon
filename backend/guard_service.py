...
# from security import SECURITY_STATE
...
#     print(f"\n⚡ [OUT-OF-BAND ESCALATION] Background worker firing call script to {admin_phone}...")
...
#     try:
#         # Dispatching the call task instance explicitly to the cloud nodes
...
#                 print("[SUCCESS] Telephony triage complete: Agent Token Revoked.")
#     except Exception as e:
#         print(f"❌ [CRITICAL CALL ROUTE FAILURE] CALL-E platform rejected request: {str(e)}")


# # Open backend/guard_service.py and replace ONLY the @app.post("/") block:

# @app.post("/")
# async def handle_demo_simulation(): # <-- Removed background_tasks parameter
#     """
#     High-visibility demo endpoint. Instantly breaks diagnostic loops,
#     flashes threat landscape to judges, handles structural holds, and fires call.
#     """
#     print("\n" + "="*60)
...
#     print("-" * 60)
#     print("LOGGED PATH: POST /api/chat/agent_4")
...
#     print("\n[PAUSE] Analyzing threat landscape stability matrix...")
    
#     # 1. Non-blocking sleep keeps the application wide awake
#     await asyncio.sleep(2) 
    
#     print("⚡ [SYSTEM CONTROL] Offloading thread lane... Dispatching CALL-E API payload...")
    
#     # 2. FIX: Instead of background_tasks, we explicitly force Python to run 
#     # your blocking phone function inside a completely separate thread lane worker!
...
def trigger_calle_voice_containment():
    ...
    print(f"\n⚡ [OUT-OF-BAND ESCALATION] Isolated background thread firing call script to {admin_phone}...")
